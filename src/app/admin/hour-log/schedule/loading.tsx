...
// Renders inside src/app/admin/layout.tsx (AppShell), below the
// schedule sub-nav (layout.tsx). Mirrors the hero layout of page.tsx:
// back link, kicker, date h1, sublabel, then the WeekNav +
// ProgramScheduleGrid block.
...
export default function Loading() {
  return (
    <LoadingShell>
      ...
      {/* Schedule grid — header row + 4 program rows × 14 cells */}
