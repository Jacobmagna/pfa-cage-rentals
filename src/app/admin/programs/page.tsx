...
// clear a per-program session cap + period (DEC-03). Per-program coach
// assignment was removed in DEC-29 — coaches can now log hours / take
// attendance for ANY active program, so there's no coach_programs surface
// here anymore.
//
// Server-fetches all programs, then hands them to the client island.
// This route has no section layout, so the page owns its own <h1>.
