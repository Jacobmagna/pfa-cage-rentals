...
// (America/Los_Angeles) timezone. These lock the pure date math so a
...
describe("defaultSessionsRange", () => {
  it("returns today−14d → today+14d for a fixed mid-day instant", () => {
    // 2026-06-04 16:00Z is 09:00 PDT on 2026-06-04 (PFA today = Jun 4).
  ...
  it("uses PFA TZ for 'today', not UTC (late-night PT before UTC rollover)", () => {
    // 2026-06-05 02:30Z is still 2026-06-04 19:30 PDT — PFA today = Jun 4,
  ...
  it("rolls over month/year boundaries correctly", () => {
    // 2026-01-08 09:00 PST → from crosses into prior year (Dec 2025),
