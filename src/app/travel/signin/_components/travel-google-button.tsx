...
function GoogleButton() {
  ...
  return (
    <button
      ...
      className="w-full rounded-md bg-yellow text-gold-ink h-10 px-4 text-sm font-semibold transition-colors hover:bg-gold-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow/40 disabled:opacity-50 disabled:cursor-not-allowed"
    >
